...
const DEFAULTS: Record<string, ElementDefaults> = {
  Section: {
    width: 600,
    height: 240,
    styles: { background: "#1a1a20", "border-radius": "8px" },
  },
  Container: {
    width: 480,
    height: 200,
    styles: { background: "#1f1f26", "border-radius": "8px" },
  },
  Div: {
    width: 240,
    height: 140,
    styles: { background: "#23232b", "border-radius": "6px" },
  },
  Navbar: {
    width: 720,
    height: 64,
    styles: { background: "#16161b", "border-radius": "8px" },
  },
  Sidebar: {
    width: 240,
    height: 360,
  ...
  Text: {
    ...
    height: 28,
    text: "Text",
    styles: { color: "#e6e6eb", "font-size": "15px" },
  },
  Link: {
    width: 120,
    height: 24,
  ...
  Image: {
    width: 240,
    height: 160,
    styles: { background: "#2c2c34", "border-radius": "6px" },
  },
  Video: {
    width: 320,
    height: 180,
...
const FALLBACK: ElementDefaults = {
  width: 160,
  height: 80,
  styles: { background: "#23232b", "border-radius": "6px" },
};
